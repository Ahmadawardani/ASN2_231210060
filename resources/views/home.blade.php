    ...
    <div class="container">
        ...
        @php
            $fitur = [
                ...
                ['icon' => 'fas fa-sitemap', 'color' => 'maroon', 'title' => 'Struktur Kepanitiaan', 'desc' => 'Lihat susunan panitia kegiatan dan siapa saja yang terlibat dalam organisasi.', 'route' => 'kepanitiaan.index', 'btn' => 'dark'],
            ];
        @endphp
